...
namespace World_s_hardest_game
{
    ...
    partial class Game
    {
        ...
        private void ReadBmpSquare(string path)
        {
        ...
        private void ReadBmpTiles(string path)
        {
            Bitmap bmp = new Bitmap(path);
        ...
        /// <summary>
        /// Computes the intersection of lines p1-p2 and p3-p4
        /// </summary>
        /// <param name="p1"></param>
        /// <param name="p2"></param>
        /// <param name="p3"></param>
        ...
        private bool BallPlayerCollision(Square player, Ball ball)
        {
